        ...
        {programType === 'SUPPLEMENTAL_FEE' ? (
          <>
            ...
            <div className="bg-gradient-to-r from-dmp-blue-100 to-green-100 rounded-lg p-6 border-2 border-dmp-blue-300">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-lg font-semibold text-gray-800">Monthly Savings</span>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
              <div className="flex items-center gap-2 mb-2">
                ...
                <Button
                  ...
                  size="sm"
                  className="h-auto p-0"
                  onClick={() => onTooltip('gross-profit')}
                  data-testid="button-tooltip-gross-profit"
                >
            ...
            <div className="bg-purple-50 rounded-lg p-4 border border-purple-200">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-sm font-medium text-gray-600">Skytab Bonus Calculation (Gross)</span>
                <Button
                  variant="ghost"
                  size="sm"
                  className="h-auto p-0"
            ...
            <div className="bg-indigo-50 rounded-lg p-4 border border-indigo-200">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-sm font-medium text-gray-600">Skytab Bonus Calculation (Rep 50%)</span>
                <Button
                  variant="ghost"
                  size="sm"
                  className="h-auto p-0"
