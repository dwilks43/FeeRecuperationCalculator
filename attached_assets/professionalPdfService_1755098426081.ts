...
export async function generateProfessionalPdf(
    ...
    try {
        console.log("🔥 PROFESSIONAL PDF SERVICE - Starting generation");
        console.log("🔥 Quote ID:", id);
        console.log("🔥 Quote Number:", quote.quoteNumber);
        console.log("🔥 DocRaptor API Key present:", !!apiKey);
        ...
        if (id) {
            ...
            console.log(
                "🎯 Using comprehensive professional template:",
                previewUrl,
            );
            ...
            console.log("allFinancingOptions", allFinancingOptions);
            // LIVE QUOTE: Generate HTML directly for quotes without IDs using external image approach
            console.log("🎯 Using external image approach for live quote");
        ...
        // Call DocRaptor API with professional configuration
        console.log("🔥 Calling DocRaptor API...");
        console.log(
            "🔥 DocConfig preview:",
            JSON.stringify(docConfig, null, 2).slice(0, 500),
        );
        ...
        console.log("🔥 DocRaptor response status:", response.status);
        console.log("🔥 DocRaptor response ok:", response.ok);
